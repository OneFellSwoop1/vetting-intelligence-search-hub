...
class CheckbookNYCAdapter:
    """
    Improved Adapter for NYC Checkbook data via Socrata API
    Uses your existing Socrata credentials with enhanced functionality
    """
    ...
    def __init__(self):
        ...
        # Enhanced dataset mapping with more comprehensive coverage
        self.datasets = {
    ...
    async def search(self, query: str, year: int = None) -> List[Dict[str, Any]]:
        ...
        Now includes revenue data and improved data coverage
        """
